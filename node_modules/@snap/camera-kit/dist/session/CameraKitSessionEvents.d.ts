import type { LensExecutionError, LensImagePickerError, LensAbortError, LensVideoPlaybackMutedError } from "../namedErrors";
 ...
 *     - {@link LensVideoPlaybackMutedError} Video playback was muted due to browser autoplay policies.
...
export type CameraKitSessionEvents = TypedCustomEvent<"error", {
    error: LensExecutionError | LensAbortError | LensImagePickerError | LensVideoPlaybackMutedError;
    lens: Lens;
}>;
/**
