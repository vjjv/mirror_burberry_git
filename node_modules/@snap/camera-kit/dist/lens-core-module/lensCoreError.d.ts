...
export type LensCoreVideoPlaybackFailedError = NamedError<"LensCoreVideoPlaybackFailedError">;
export type LensCoreVideoPlaybackMutedError = NamedError<"LensCoreVideoPlaybackMutedError">;
export type LensCoreUnknownError = NamedError<"LensCoreUnknownError">;
export type LensCoreError = LensCoreLensDeserializationError | LensCoreValidationError | LensCoreUncategorizedError | LensCoreLensExecutionError | LensCoreAbortError | LensCoreUninitializedError | LensCoreVideoPlaybackFailedError | LensCoreVideoPlaybackMutedError;
